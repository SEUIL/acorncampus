...
public class 변수와배열 {
	...
	public static void main(String[] args) {
		...
		//배열(5개) :연속적으로 공간확보, 기준(배열이름)으로 부터 인덱스로 접근한다 
		//인덱스의 의미:   기준(배열이름)으로 부터 크기(자료형)만큼 떨어진 위치
		...
		System.out.println( name2);   //변수는 접근시 반드시 변수이름으로만 접근가능하다 !!!!
		...
		//String[] names = {"장윤성", "엄진희", "이정하" , "정철진", "김재민" } ;   //배열선언및 초기화
